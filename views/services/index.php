...
if ($messageId != "") {
    $this->registerJs('loadServicesMessage(' . Html::encode($messageId) . ');');
}
?>
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <?php echo Html::a(Yii::t('MailModule.views_mail_index', 'New message'), ['/services/services/create'], array('class' => 'btn btn-info pull-right', 'data-target' => '#globalModal')); ?>
                </div>
