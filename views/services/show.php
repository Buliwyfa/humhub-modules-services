...
<div class="panel panel-default">
    ...
    <?php } else { ?>
                ...
                <?php if (count($message->users) != 0) : ?>
                    <?php if (count($message->users) != 1) : ?>
                        ...
                        echo ModalConfirm::widget(array(
                            ...
                            'linkHref' => Url::to(["/services/services/leave", 'id' => $message->id])
                        ));
                        ?>
                    <?php endif; ?>
                    <?php if (count($message->users) == 1) : ?>
        ...
        <div class="panel-body">
            ...
            <ul class="media-list">
                <!-- BEGIN: Results -->
                <?php foreach ($message->servicesentries as $entry) : ?>
                    <div class="media" style="margin-top: 0;">
                        ...
                        <?php if ($entry->created_by == Yii::$app->user->id): ?>
                            <div class="pull-right">
                                <?php echo Html::a('<i class="fa fa-pencil-square-o"></i>', ["/services/services/edit-entry", 'messageEntryId' => $entry->id], array('data-target' => '#globalModal', 'class' => '')); ?>
                            </div>
                        <?php endif; ?>
            ...
            <div class="row-fluid">
                ...
                echo \humhub\widgets\AjaxButton::widget([
                    ...
                    'ajaxOptions' => [
                        ...
                        'url' => Url::to(['/services/services/show', 'id' => $message->id]),
                    ],
                    'htmlOptions' => [
                ...
                <div class="pull-right">
                    ...
                    <?php
                    echo Html::a('<i class="fa fa-plus"></i> ' . Yii::t('MailModule.views_mail_show', 'Add user'), ['/services/services/add-user', 'id' => $message->id, 'ajax' => 1], array(
                        'class' => 'btn btn-info',
