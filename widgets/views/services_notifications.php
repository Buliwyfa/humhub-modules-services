...
<script type="text/javascript">
    ...
    $('#icon-services').click(function () {
        ...
        $('#dropdown-services').append('<li class="dropdown-header"><div class="arrow"></div><?php echo Yii::t('ServicesModule.widgets_views_serviceNotification', 'Service Messages'); ?> <?php echo Html::a(Yii::t('ServicesModule.widgets_views_serviceNotification', 'New service message'), Url::to(['/services/services/create', 'ajax' => 1]), array('class' => 'btn btn-info btn-xs', 'id' => 'create-message-button', 'data-target' => '#globalModal')); ?></li> <ul class="media-list"><li id="loader_messages"><div class="loader"></div></li></ul><li><div class="dropdown-footer"><a class="btn btn-default col-md-12" href="<?php echo Url::to(['/services/services/index']); ?>"><?php echo Yii::t('ServicesModule.widgets_views_serviceNotification', 'Show all service messages'); ?></a></div></li><li><div class="dropdown-footer"><a class="btn btn-default col-md-12" href="<?php echo Url::to(['/services/find/services']); ?>"><?php echo Yii::t('ServicesModule.widgets_views_serviceNotification', 'Find a service'); ?></a></div></li><li><div class="dropdown-footer"><a class="btn btn-default col-md-12" href="<?php echo Url::to(['/services/services/switch']); ?>"><?php echo Yii::t('ServicesModule.widgets_views_serviceNotification', 'Switch ON|OFF your services'); ?></a></div></li>');
